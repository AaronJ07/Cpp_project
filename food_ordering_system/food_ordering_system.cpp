...
void registration(){
    system("cls");
	cout<<"\t\t\t|-----------------------------------------------------|\n";
	cout<<"\t\t\t|              sammi|dahasu|harman Fast Food          |\n";
	cout<<"\t\t\t|-----------------------------------------------------|\n\n";
...
void pizza_size(string piz_name){
	...
	cout<<"\n1) Small RM.250.00\n";
    cout<<"2) Regular RM.500.00\n";
    cout<<"3) Large RM.900.00\n";
    cout<<"4) Go Back\n";
    cout<<"5) Go Back Home\n";
...
void burger_category(){
        ...
        cout<<"\t\t\t|-----------------------------------------------------|\n\n";
        cout<<"\n1) "<<burger_1<<" RM.180"<<"\n";
		cout<<"2) "<<burger_2<<" RM.150"<<"\n";
		cout<<"3) "<<burger_3<<" RM.160"<<"\n";
		cout<<"4) Go Back"<<"\n";
...
void sandwich_category(){
        ...
        cout<<"\t\t\t|-----------------------------------------------------|\n\n";
        cout<<"\n1)  "<<sandwich_1<<" RM.240.00"<<"\n";
		cout<<"2)  "<<sandwich_2<<" RM.160.00"<<"\n";
		cout<<"3)  "<<sandwich_3<<" RM.100.00"<<"\n";
		cout<<"4) Go Back"<<"\n";
...
void drinks_category(){
        ...
        cout<<"\t\t\t|-----------------------------------------------------|\n\n";
        cout<<"\n1) "<<drinks1<<" RM.15.00"<<"\n";
		cout<<"2) "<<drinks2<<" RM.20.00"<<"\n";
		cout<<"3) "<<drinks3<<" RM.30.00"<<"\n";
		cout<<"4) Go Back "<<"\n";
...
void fried_category(){
        ...
        cout<<"\t\t\t|-----------------------------------------------------|\n\n";
        cout<<"\n1) "<<fried1<<" RM.160.00"<<"\n";
		cout<<"2) "<<fried2<<" RM.220.00"<<"\n";
		cout<<"3) "<<fried3<<" RM.140.00"<<"\n";
		cout<<"4) Go Back"<<"\n";
